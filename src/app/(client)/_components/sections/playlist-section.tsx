  ...
  return (
    <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-8 sm:mb-12">
        <p className="text-white text-sm sm:text-base md:text-lg lg:text-xl mb-4 leading-relaxed">
          This is an M3U8 playlist and Xtream playlist for free channels around the World. Using IPTV M3U8 links is an excellent way to enhance your TV viewing experience. With these links, you can easily access TV shows, movies, series, and sports games streaming by simply using an M3U, M3u8 playlist url or Xtream URL
        </p>
      </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <Input
                  ...
                  className="bg-[#1B1B1E] text-white text-sm sm:text-base lg:text-lg border-0 py-3 sm:py-4 lg:py-6 flex-1"
                />
                <Button variant="iptvsecondary" className="p-3 sm:p-4 lg:p-6 w-full sm:w-auto text-xs sm:text-sm lg:text-base">
                  <Copy className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
                  Copy
                </Button>
              </div>
      ...
      {/* Find More Playlist Button */}
      <div className="text-center">
        <Button
          className="bg-primary hover:bg-primary-foreground text-white px-4 sm:px-6 lg:px-8 py-3 sm:py-4 lg:py-6 text-sm sm:text-lg lg:text-2xl font-bold rounded-full uppercase w-full sm:w-auto"
        >
          find more playlist
        </Button>
      </div>
